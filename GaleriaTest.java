...
class GaleriaTest {
    ...
    void addPelicula() {
        ...
        lista.addPelicula(new Pelicula(0,"Futurama: El juego de Bender", "Dwayne Carey-Hill", "Animación"));
        /*
    ...
    void ordenarLista() {
        ...
        lista.addPelicula(new Pelicula(5,"Crepúsculo", "Ni idea","Ficción"));
        lista.addPelicula(new Pelicula(9,"Crepúsculo", "Ni idea","Ficción"));
        System.out.println(lista.toString());
        //Coge los elementos de la lista y para idPelicula le asigna un número empezando desde el 1
        //para el primer elemento de la lista y aumentando en 1 para el siguiente elemento.
        lista.ordenarLista();
        System.out.println(lista.toString());
        assertTrue(lista.getCartelera().get(0).getIdPelicula() == 1);
        assertTrue(lista.getCartelera().get(1).getIdPelicula() == 2);
        }
    }
